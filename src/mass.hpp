...
namespace operators
{
    ...
    void mass_operator(std::vector<T> &a, std::vector<T> &b, std::vector<T> &c, std::vector<T> &detJ, int num_cells, int degree, Order order)
    {
        switch (order)
        {
        case Order::ijk:
    ...
    void mass_operator(std::vector<T> &a, std::vector<T> &b, std::vector<T> &c, std::vector<T> &detJ, int num_cells, int degree, Order order, int Mb)
    {
        switch (Mb)
        {
        case 4:
    ...
    template <typename T>
    void mass_operator(std::vector<T> &a, std::vector<T> &b, std::vector<T> &c, std::vector<T> &detJ, int num_cells, int degree, Order order, int Mb, int Nb)
    {
        switch (Nb)
        {
        case 4:
